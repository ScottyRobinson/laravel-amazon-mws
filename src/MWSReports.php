...
class MWSReports
{
    ...
    {
        $response = $this->client->post('RequestReport', '/Reports/'.self::VERSION, self::VERSION, $params);

        return $response['RequestReportResult']['ReportRequestInfo'];
    }

    //GetReportRequestList
    public function getRequestReportList($params = [])
    {
        $response = $this->client->post('GetReportRequestList', '/Reports/'.self::VERSION, self::VERSION, $params);

        return $response['GetReportRequestListResult']['ReportRequestInfo'];
    }
    ...
    public function getReport($report_id)
    {
        ...
        $response = $this->client->post('GetReport', '/Reports/'.self::VERSION, self::VERSION, $params);
